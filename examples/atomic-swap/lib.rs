...
#[ink::contract]
/*
    * Swap ERC20 to DOT/KSM and vice versa
    * have signed orders containing:
    * - Signature params v,r,s
    * - Expiry timestamp check
    * - price check
    * - balance check
    * swap at the end else revert

    ** https://gist.github.com/James-Sangalli/bf18c19fbfd82e0f0e857c160c1c0c74 **
*/
...
mod atomic_swap {
    ...
    /// Event emitted when an order is successfully swapped.
    #[ink(event)]
